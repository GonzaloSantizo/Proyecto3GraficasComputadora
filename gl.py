...
class Renderer(object):
    def __init__(self, screen):
        ...
        self.camPosition = glm.vec3(5, -10, 0)  # Posiciona la cámara en z = 5
        self.camRotation = glm.vec3(0, 5, 3)  # Sin rotación, mirando hacia el origen
        self.target = glm.vec3(0, 0, 0)       # Asegúrate de que el objetivo sea el origen (o donde se encuentra tu modelo)
